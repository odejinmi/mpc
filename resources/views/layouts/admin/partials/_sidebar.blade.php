...
{{--                        </li>--}}
                        ...
                        <li class="navbar-vertical-aside-has-menu   {{ Request::is('admin/report/disbursement-report/restaurant') || Request::is('admin/report/disbursement-report/delivery_man')  ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                               title="{{ translate('messages.disbursement_report') }}">
                                <span class="tio-saving nav-icon"></span>
                                <span
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/report/disbursement-report/restaurant') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('admin.report.disbursement_report',  ['tab' => 'restaurant']) }}"
                                       title="{{ translate('messages.restaurants') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                    ...
                    <li
                        ...
                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                           ...
                           title="{{ translate('messages.dm_disbursement') }}">
                            ...
                            <span
                                class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ translate('messages.delivery_man') }}
                              <span class="badge badge-soft-info badge-pill ml-1">
